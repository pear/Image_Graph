 ...
 * The function must be a single variable function and return a the result, builtin functions
 * that are fx sin() or cos().
 * User defined function can be used if they are such, i.e: function myFunction($variable)
 * User defined function can be used if they are such, i.e: {
 */
class Image_Graph_Dataset_Function extends Image_Graph_Dataset 
{
     ...
     * @param string $function The name of the function, if must be a single parameter function like fx sin(x) or cos(x)
